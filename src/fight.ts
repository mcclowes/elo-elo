import type { IndexData, EloData, Coefficients } from "./types";
import * as utils from "./utils";
import getNewElo from "./getNewElo";

const fight = (
  indexData: IndexData,
  coefficients: Pick<Coefficients, "kFactor" | "gravity" | "energy" | "baseline" | "fights">
): EloData => {
  const { kFactor, gravity, energy, baseline, fights } = coefficients;
    ...
    if (player1score && player2score) {
      ...
      if (player1score < player2score) {
        ...
        const [newPlayer1Elo, newPlayer2Elo] = getNewElo(
          { elo: eloData[player1].elo, score: 1 },
          { elo: eloData[player2].elo, score: 0 },
          kFactor,
          gravity,
          energy,
          baseline
        ...
        const [newPlayer1Elo, newPlayer2Elo] = getNewElo(
          { elo: eloData[player1].elo, score: 0 },
          { elo: eloData[player2].elo, score: 1 },
          kFactor,
          gravity,
          energy,
          baseline
        ...
        const [newPlayer1Elo, newPlayer2Elo] = getNewElo(
          { elo: eloData[player1].elo, score: 0.5 },
          { elo: eloData[player2].elo, score: 0.5 },
          kFactor,
          gravity,
          energy,
          baseline
